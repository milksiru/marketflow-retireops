...
def _family_plan():
    ...
    return {
        ...
        "presale": {
            "title": "3기 신도시 왕숙2지구 A4",
            "status": "신혼희망타운 사전청약 당첨",
            "notice": "2022년 2월 사전청약 입주자모집공고 기준",
            "expected": "본청약 2027년 예상",
            "plan": "시세와 본청약 분양가가 확정되면 6억~7억 매매 목표보다 왕숙2 A4 입주 가능성을 우선 검토합니다.",
            "focus": [
                "본청약 공고 일정과 분양가 확정 확인",
                "계약금·중도금·잔금 현금흐름 분리",
                "전세보증금 반환 시점과 대출 실행 시점 연결",
                "차 할부 1억 감축 여부와 주택 대출 한도 동시 점검",
            ],
            "note": "사전청약 당첨은 중요한 우선 시나리오지만, 최종 조건은 본청약 공고와 당시 시세·금리·대출 규정에 따라 달라질 수 있습니다.",
        },
        "assets": [
